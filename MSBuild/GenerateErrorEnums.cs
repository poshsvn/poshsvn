...
namespace MSBuild
{
    public class GenerateErrorEnums : Task
    {
        ...
        private void WriteWinEnumBody(StreamReader header, StreamWriter r)
        {
        ...
        private void WriteAprEnumBody(StreamReader header, StreamWriter r, bool direct, string prefix, Dictionary<string, string> defined)
        {
            string line;
